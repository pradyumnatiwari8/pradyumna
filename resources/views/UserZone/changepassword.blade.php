    ...
    <div class="row">
            ...
            <div class="col-sm-12">
                ...
                <div class="col-sm-8 panel panel-body" style="min-height: 320px;height: 330px;width: 400px; box-shadow: 0px 0px 20px 10px teal;margin-top: 20px;margin-bottom: 30px;">
                    <form action="changepasswordcode" method="post" id="frm">
                    ...
                    <input type="submit"  class="btn btn-success" value="Change Password" style="margin-bottom: 10px;margin-top: 10px;"/>
                    </form>
                </div>
