    ...
    <div class="row">
        <div class="col-sm-12">
            ...
            <div class="col-sm-8 panel panel-body" style="min-height: 240px; box-shadow: 0px 0px 20px 10px teal;margin-top: 20px;margin-bottom: 30px;">
                ...
                <div class="row">
                    <div class="col-sm-12">
                        <form action="complaintcode" method="post"  enctype="multipart/form-data">
                        ...
                        <div class="col-sm-6" >
                            <label style="font-size: 20px;color: maroon;font-family: thomba">Subject</label>
                            <textarea name="msg" placeholder="Write Something" style="min-height:170px;" class="form-control"></textarea>
